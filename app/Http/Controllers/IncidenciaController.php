...
class IncidenciaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('incidencias.index')->with('status', 'creada');
    }
    ...
    {
        // Obtener las incidencias asignadas al usuario autenticado
        $incidencias = Incidencia::with(['statu', 'emergencia', 'categoria', 'subcategoria'])
            ->where('asignado_id', Auth::user()->idusuario) // id de usuario autenticado
            ->orderBy('incidencias.id', 'desc')
            ->get();

        return view('incidencias.mis_asignadas', compact('incidencias'));
    }
    ...
    public function edit(Incidencia $incidencia)
    {
        ...
        $archivos = $incidencia->archivos; // Obtener los archivos relacionados

        return view('incidencias.edit', compact('incidencia', 'categorias', /* 'subcategorias', */ 'emergencias', 'archivos'));
    }
    ...
    public function update(Request $request, Incidencia $incidencia)
    {
        ...
        // Actualiza los campos de la incidencia
        $incidencia->update([
            ...
            'emergencia_id' => $request->input('emergencia_id'),
        ]);
        ...
        // return redirect()->route('incidencias.index')->with('info', 'Incidencia actualizada con éxito');
        return redirect()->route('incidencias.index')->with('status', 'actualizada');
    }
    ...
    public function destroy(Incidencia $incidencia)
    {
        ...
        return redirect()->route('incidencias.index')->with('status', 'eliminada');
    }
