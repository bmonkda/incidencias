<div class="table-responsive">
    <table id="detalle" class="table table-bordered mb-4 contextual-table">
        ...
        <tbody>
            <tr class="table-primary">
                ...
                <td class="text-center"><span class="badge outline-badge-dark{{-- primary --}}"
                        style="background-color: {{ $incidencia->statu->color2 }}"> {{ $incidencia->statu->nombre }}
                    </span></td>
        ...
        <thead>
            <tr class="table-dark">
                <th class="text-center text-dark">Archivos relacionado</th>
        </thead>

        <!-- Muestra los archivos relacionados con la incidencia -->
        <tbody>
            <tr class="table-primary">
