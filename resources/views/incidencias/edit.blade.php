...
@section('content')
    ...
    <form action="{{ route('incidencias.update', $incidencia->id) }}" method="POST" autocomplete="off"
        ...
        <!-- Campo de archivo para agregar uno nuevo -->
...
@section('scripts')
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('categoria').addEventListener('change', function() {
                ...
                subcategoriaSelect.innerHTML = '<option value="" @if (old('subcategoria_id') === null && !isset($incidencia->subcategoria_id)) selected @endif disabled>Seleccionar Subcategoría</option>';
    ...
    {{-- <script src="{{ asset('template/assets/js/incidencias/selectSubcategoria.js') }}"></script> --}}
