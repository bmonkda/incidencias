                    ...
                    <div class="form-form-wrap">
                        <div class="form-container">
                            <div class="form-content">
                                ...
                                <h1 class=""> <a href="#"><span class="brand-name">Iniciar sesión</span></a></h1>
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="d-sm-flex justify-content-between">
                                            ...
                                            <div class="field-wrapper">
                                                <button type="submit" class="btn btn-primary" value="">Iniciar</button>
                                            </div>
                                ...
                                <p class="terms-conditions bg-white">© 2023 Todos los derechos reservados. Diseñado en <a href="{{ route('home') }}">HIDROBOLÍVAR</a> por la Gerencia de Tecnología e Información.</p>
